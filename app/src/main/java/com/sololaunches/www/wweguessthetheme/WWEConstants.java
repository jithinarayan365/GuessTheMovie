...
public class WWEConstants {
   ...
   static String MAIN_WWE_TABLE = "CREATE TABLE WWE_STAGE_MAIN ( MAIN_ID INTEGER PRIMARY KEY,PLAYER TEXT,ALIAS TEXT,PATH TEXT,DISPLAY_NAME TEXT,HINT TEXT,HINT_STATUS TEXT,AD_STATUS TEXT,STATUS TEXT);";
